...
GirderMarker.prototype.masterRight = function () {
  ...
  masterPos.top = function() {
    ...
    else return new Phaser.Point( masterPos.x + sine * 32, masterPos.y + sine * 32 );
  }

  masterPos.front = function() {
    if ( Math.abs( cosine ) > 1 - EPSILON ) return new Phaser.Point( masterPos.x + cosine * 32, masterPos.y );
